...
from framework.modules.languages.core.fr.Determining import Determining
from framework.modules.languages.core.fr.model.DetermineModel import DetermineModel


class Fr(DetermineModel):
