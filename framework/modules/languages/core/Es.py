...
from framework.modules.languages.core.es.Determining import Determining
from framework.modules.languages.core.es.model.DetermineModel import DetermineModel


class Es(DetermineModel):
