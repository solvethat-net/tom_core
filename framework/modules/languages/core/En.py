...
from framework.modules.languages.core.en.Determining import Determining
from framework.modules.languages.core.en.model.DetermineModel import DetermineModel


class En(DetermineModel):
