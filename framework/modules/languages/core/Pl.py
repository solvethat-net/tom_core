...
from framework.modules.languages.core.pl.Determining import Determining
from framework.modules.languages.core.pl.model.DetermineModel import DetermineModel


class Pl(DetermineModel):
