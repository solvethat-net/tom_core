...
class MetadataSynonym:
    ...
    synonyms = [
        [MetadataEnum.CREATE, " creare "],
        [MetadataEnum.DELETE, " elimina "],
        [MetadataEnum.MOVE, " mossa "],
        [MetadataEnum.COPY, " copia "],
        [MetadataEnum.CUT, " taglio "],
        [MetadataEnum.OPEN, " aprerto "],
        [MetadataEnum.SEND, " spedire "],
        [MetadataEnum.WRITE, " scrivi "],
        # [MetadataEnum.CHECK, " dai un'occhiata "],
        [MetadataEnum.ERASE, " cancellare "],
        [MetadataEnum.WAIT, " aspettare "],
        [MetadataEnum.UPLOAD, " caricare "],
        [MetadataEnum.START, " inizio "],
        [MetadataEnum.FILE, " file "],
        [MetadataEnum.DIRECTORY, " direttorio "],
    ]
