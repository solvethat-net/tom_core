...
from framework.modules.languages.core.sk.Determining import Determining
from framework.modules.languages.core.sk.model.DetermineModel import DetermineModel


class Sk(DetermineModel):
